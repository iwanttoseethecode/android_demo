...
public class UniversalViewHolder extends RecyclerView.ViewHolder {
    ...
    public static UniversalViewHolder get(Context context, View convertView, ViewGroup parent, int layoutId) {
        if(convertView == null) {
            ...
            UniversalViewHolder holder1 = new UniversalViewHolder(holder2);
    ...
    public UniversalViewHolder setSelected(int viewId, boolean selected) {
    ...
    public UniversalViewHolder setOnTouchListener(int viewId, View.OnTouchListener listener) {
        View view = this.getView(viewId);
        view.setOnTouchListener(listener);
        return this;
    }

    public UniversalViewHolder setOnLongClickListener(int viewId, View.OnLongClickListener listener) {
        View view = this.getView(viewId);
