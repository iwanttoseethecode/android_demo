...
public class ComposeShaderView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        LinearGradient lg = new LinearGradient(0,0,getMeasuredWidth(),0, Color.RED,Color.BLUE,Shader.TileMode.CLAMP);
        ComposeShader cs = new ComposeShader(bs,lg, PorterDuff.Mode.DST_ATOP);
