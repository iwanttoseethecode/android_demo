...
/**
 * Created by luoling on 2017/6/2.
 */

public class XformodeShowView extends View {
    ...
    public XformodeShowView(Context context) {
        super(context);
        init(null, 0);
    }

    public XformodeShowView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public XformodeShowView(Context context, AttributeSet attrs, int defStyle) {
